      ...
      <>
        {
          ...
          <div className='flex flex-col h-full bg-[#0d0f14]'>
            <div className='h-14 px-4 border-b border-white/[0.06] flex items-center gap-3 shrink-0'>
              ...
              >
                {onClose ? <X size={15} /> : <PanelRightClose size={24} />}
              </button>
  ...
  return (
    <>
      <button
        ...
        className='lg:hidden fixed bottom-24 right-4 z-40 flex items-center gap-2 px-3.5 py-2 rounded-xl transition-colors duration-150
      ...
      <motion.div
        initial={{width:400}}
        animate={{width:collapsed ? 58 : 400}}
        transition={{
          duration:0.25,
          ease:easeInOut,
        }}
